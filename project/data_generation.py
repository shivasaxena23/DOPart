...
def system_values(i, profile_model: str | None = None):
    ...
    if selected_profile is not None:
        ...
        raw_profile_path = DATA_RAW_DIR / "resnet34_compute_values_224_t4.npy"
        if not raw_profile_path.exists():
            raw_profile_path = REPO_ROOT / "resnet34_compute_values_224_t4.npy"
        with raw_profile_path.open("rb") as f:
